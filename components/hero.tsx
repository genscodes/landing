...
export function Hero() {
  ...
  return (
    <section className="relative flex min-h-0 flex-col items-center justify-center overflow-hidden bg-[#000000] px-6 py-20 sm:py-24">
      {/* Announcement badge */}
      <div className="relative mb-10 flex items-center gap-2 rounded-full border border-border/60 bg-secondary/50 px-5 py-2 text-xs text-muted-foreground backdrop-blur-sm">
